...
Per aquest motiu, i dins de la vostra formació al departament de **seguretat informàtica**, rebreu una formació bàsica sobre el tema, per tal de poder afrontar els reptes que els nostres clients ens proposen.
...
Un cop finalitzada la formació, hauràs de respondre un **qüestionari** per tal d’avaluar el teu grau d’assoliment.
